// components/muscles/BackModal.tsx
...
const BackModal: React.FC<BackModalProps> = ({ visible, onClose }) => {
  const exercises = [
    "Deadlift",
    "Bent Over Row",
    "Pull-Ups",
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch("http://3.88.218.74:8082/add/back", {
        method: "POST",
        headers: {
    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalHeader}>Ejercicios para Espalda</Text>
