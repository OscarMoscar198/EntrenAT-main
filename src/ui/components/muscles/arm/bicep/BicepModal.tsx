...
const BicepModal: React.FC<BicepModalProps> = ({ visible, onClose }) => {
  const exercises = ["Bicep Curls", "Hammer Curls", "Barbell Curls"];
  ...
  const handleSave = async () => {
    try {
      const userId = 2;
      const exercisesId = 3; // Actualizar con el ID correcto
    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalHeader}>Ejercicios para Bíceps</Text>
